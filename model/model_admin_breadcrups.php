	...
	public function get($c){
		if(isset($_GET['action']) && !empty($_GET['action'])){
			...
			switch($_GET['action'])
			{
				...
				$this->breadcrups .= '<a href="?action=editNewsItem&type='.$_GET['type'].'&id='.$_GET['id'].'&newsidx='.$_GET['newsidx'].'&super='.$_GET['super'].'">'.$getnewstitle.' <i class="fa fa-caret-right"></i></a>';
				break;
				case "userList":
				$this->breadcrups .= '<a href="?action=userList">Admin users <i class="fa fa-caret-right"></i></a>';
				break;
				case "loadnewsletter":
				$this->breadcrups .= '<a href="?action=loadnewsletter">Load sended newsletters <i class="fa fa-caret-right"></i></a>';
				break;
				case "addAdmin":
				$this->breadcrups .= '<a href="?action=userList">Admin users <i class="fa fa-caret-right"></i></a>';
				...
				break;
				case "fusersstat":
				$this->breadcrups .= '<a href="?action=fusersstat">Users &amp; Products &amp; Services <i class="fa fa-caret-right"></i></a>';
				break; 
				case "edituserstats":
