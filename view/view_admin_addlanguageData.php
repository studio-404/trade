		...
		<div class="center">
			...
			<div class="content">
				...
				<form action="" method="post" class="my-form hundredPorsent" autocomplete="off">
					<div class="from-header" style="color:#ef4836; text-transform:uppercase">Add language data</div>
					
					<label for="variable">Variable: <font color="RED">*</font></label>
					<input type="text" name="variable" id="variable" value="" autocomplete="off" />

					<label for="text">Text: <font color="RED">*</font></label>
					<input type="text" name="text" id="text" value="" autocomplete="off" />

					
					<input type="submit" name="add_language_data" id="submit" value="Submit"><br>
				</form>
			</div>
		</div>
	</main>
