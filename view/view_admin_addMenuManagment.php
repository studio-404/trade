	...
	<main>
		<div class="center">
			...
			<div class="content">
				...
				<div class="from-header" style="color:#ef4836; text-transform:uppercase">Add page manager</div>
				
				<label>Title: <font color="RED">*</font></label>
				<input type="text" name="title" value="" />

				<label>Item per page:</label>
				<input type="text" name="itemperpage" value="0" />
				
				<input type="submit" name="add_pageManager" id="submit" value="Submit"><br>
				</form>
			</div>
		</div>
	</main>
