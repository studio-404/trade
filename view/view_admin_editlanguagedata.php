		...
		<div class="center">
			...
			<div class="content">
				...
				<form action="" method="post" class="my-form hundredPorsent" autocomplete="off">
					...
					<input type="text" name="variable" id="variable" value="<?=htmlentities($data["info"]["variable"])?>" autocomplete="off" disabled="disabled" />

					<label for="text">Text: <font color="RED">*</font></label>
					<input type="text" name="text" id="text" value="<?=htmlentities($data["info"]["text"])?>" autocomplete="off" />


					
					<input type="submit" name="edit_language_data" id="submit" value="Submit"><br>
				</form>
			</div>
		</div>
	</main>
