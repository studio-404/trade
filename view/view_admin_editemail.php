		...
		<div class="center">
			...
			<div class="content">
				...
				<form action="" method="post" class="my-form hundredPorsent" autocomplete="off">
					<div class="from-header" style="color:#ef4836; text-transform:uppercase">Edit email</div>
					
					<label for="name">Name: <font color="RED">*</font></label>
					<input type="text" name="name" id="name" value="<?=htmlentities($data['info']['name'])?>" autocomplete="off">

					<label for="email">Email: <font color="RED">*</font></label>
					<input type="text" name="email" id="email" value="<?=htmlentities($data['info']['email'])?>" autocomplete="off">
					
					
					<input type="submit" name="edit_email" id="submit" value="Submit"><br>
				</form>
			</div>
		</div>
	</main>
