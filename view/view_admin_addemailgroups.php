		...
		<div class="center">
			...
			<div class="content">
				...
				<form action="" method="post" class="my-form hundredPorsent" autocomplete="off">
					<div class="from-header" style="color:#ef4836; text-transform:uppercase">Add email groups</div>
					
					<label for="groupname">Group name: <font color="RED">*</font></label>
					<input type="text" name="groupname" id="groupname" value="" autocomplete="off">
					
					
					<input type="submit" name="add_emailgroup" id="submit" value="Submit"><br>
				</form>
			</div>
		</div>
	</main>
