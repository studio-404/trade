		...
		<div class="center">
			...
			<div class="content">
				...
				<form action="" method="post" class="my-form hundredPorsent" autocomplete="off">
					<div class="from-header" style="color:#ef4836; text-transform:uppercase">Add catalog item</div>
					...
					<span class="frURL"><?=WEBSITE.LANG?>/<?=PRE_VIEW?>/</span>
					...
					<input type="submit" name="add_catalog" id="submit" value="Submit"><br>
				</form>
			</div>
		</div>
	</main>
