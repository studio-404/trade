...
<div class="container" id="container">
	<div class="col-sm-3" id="sidebar">
		...
		<ul class="text_formats_ul">
			...
			<li class="text_formats"><a href="">PDF</a></li>
		</ul>
		<?php endif; ?>
		...
		<ul class="text_formats_ul contact_text <?=($data["get_type"]!="manufacturer" && $data["get_type"]!="serviceprovider") ? 'single_contact' : ''?>">
			...
			<?php if($_GET['t']=="individual") : ?>
			<li class="text_formats">Mobile Number: <?=strip_tags($data["fetch"]["mobile"])?></li>
			<?php endif; ?>
			<li class="text_formats">E-mail: <a href="mailto:<?=strip_tags($data["fetch"]["email"])?>"><script>document.write('<?=strip_tags($data["fetch"]["email"])?>')</script></a></li>
			<?php
			...
			<li class="text_formats">Person: <?=strip_tags($data["fetch"]["contact_person"])?></li>
			<li class="text_formats">Position: </li>
			<li class="text_formats">Mobile Number: <?=strip_tags($data["fetch"]["mobile"])?></li>
			<li class="text_formats">Email: </li>
			<li class="text_formats">&nbsp;</li>
			<li class="text_formats"><b>Contact person 2</b></li>
			<li class="text_formats">Person: </li>
			<li class="text_formats">Position: </li>
			<li class="text_formats">Mobile Number: </li>
			<li class="text_formats">Email: </li>
			<?php endif; ?>
		</ul>
