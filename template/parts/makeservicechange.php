    ...
    <div class="modal-content">
		<div class="modal-body">		
					...
					<div class="form-group">
						...
						<div class="error_message s_sdescription_required">Description field is required !</div>
						<div class="error_message s_sdescription_length">Description is too long !</div>
						<div id="maxlengthservicePopup" style="width:100%; text-align:left; color:#555555">0 / 250</div>
					</div>	
