				...
				<div role="tabpanel" class="tab-pane active" id="export_catalogue">
					<div id="first-step">
						<div class="form-group">
							...
							<div class="error_message companytype1_required">Company type is required !</div>
						</div>
						<div class="form-group">
							...
							<div class="error_message emailaddress1_message">Please check E-mail address field !</div>
							<div class="error_message emailaddress1_required">E-mail is required !</div>
							<div class="error_message emailaddress1_exists">E-mail already registered !</div>
						</div>
						<div class="form-group">
							...
							<div class="error_message password1_length_message">Passwod must be minimum 6 maxsimum 20 character !</div>
							<div class="error_message password1_required">Password is required !</div>
						</div>
						<div class="form-group">
							...
							<div class="error_message repeatpassword1_match_message">Passwords do not match !</div>
						</div>
						...
						<div class="error_message agree_required">You mast agree our rules !</div>
					...
					<div id="second-step">
						<div class="form-group">
							...
							<div class="error_message emailcode_required">Code is required !</div>
						</div>
				...
				<div role="tabpanel" class="tab-pane" id="bussines_enquires" style="margin-top:10px;">
						<div id="first-step2">
							<div class="form-group">
								...
								<div class="error_message registeras2_required">Register as is required !</div>
							</div>
							<div class="form-group">
								...
								<div class="error_message emailaddress2_message">Please check E-mail address field !</div>
								<div class="error_message emailaddress2_required">E-mail is required !</div>
								<div class="error_message emailaddress2_exists">E-mail already registered !</div>
							</div>
							<div class="form-group">
								...
								<div class="error_message password2_length_message">Passwod must be minimum 6 maxsimum 20 character !</div>
								<div class="error_message password2_required">Password is required !</div>
							</div>
							<div class="form-group">
								...
								<div class="error_message repeatpassword2_match_message">Passwords do not match !</div>
							</div>
							...
							<div class="error_message agree2_required">You mast agree our rules !</div>
						...
						<div id="second-step2">
							<div class="form-group">
								...
								<div class="error_message emailcode_required2">Code is required !</div>
							</div>
