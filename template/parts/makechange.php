		...
		<div class="modal-body">			
				...
				<div class="col-sm-6 col-xs-12">
					...
					<div class="form-group">
						...
						<form action="" method="post" enctype="multipart/form-data" id="changeProductAnalysis">
							<input type="hidden" name="pa_id" id="pa_pid" valiue="" />
							<input type="file" name="pa_pdf" id="pa_pdf" class="form-control" value="" autocomplete="off" />
						</form>
					</div>
				</div>
